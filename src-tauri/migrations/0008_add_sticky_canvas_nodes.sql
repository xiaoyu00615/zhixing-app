ALTER TABLE canvas_edges RENAME TO canvas_edges_v7;
...
ALTER TABLE canvas_nodes RENAME TO canvas_nodes_v6;
...
CREATE TABLE canvas_nodes (
    ...
    type            TEXT    NOT NULL CHECK (type IN ('text', 'sticky')),
...
SELECT id, canvas_id, type, content_json, x, y, created_at_ms, updated_at_ms
FROM canvas_nodes_v6;
...
DROP TABLE canvas_edges_v7;
DROP TABLE canvas_nodes_v6;
