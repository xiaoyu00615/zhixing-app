  ...
  invokeMock.mockImplementation(
    (command: string, args?: Record<string, unknown>) => {
      switch (command) {
        ...
        case 'task_list_trashed':
          return backend.listTrashedTasks()
        case 'task_trash':
          return backend.trashTask(
            args?.input as import('@/task/repository').TrashTaskInput,
          )
        case 'task_restore':
        ...
        case 'task_add_tag':
          return backend.addTaskTag(
            args?.input as import('@/task/repository').AddTaskTagInput,
          )
        case 'task_remove_tag':
          return backend.removeTaskTag(
            args?.input as import('@/task/repository').RemoveTaskTagInput,
          )
        default:
